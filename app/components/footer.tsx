...
export function Footer() {
  return (
    <footer className="relative z-50 bg-transparent md:fixed md:right-0 md:bottom-0 md:left-0">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link
              ...
              className="font-semibold text-gray-500 text-sm transition-colors hover:text-gray-900"
            >
              CV
            </Link>
            <Link
